...
// 12x9. Left arrow, symmetric about the band's centre row so it aligns with
// the battery beside it. Straight strokes only, which is why it holds up at
// this size where a curved shape would not.
static const int kNoSleepW = 12;
