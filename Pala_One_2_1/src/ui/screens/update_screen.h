...
private:
  enum class Phase {
    ...
    Idle,         // connected — "Check for update" button live
    Checking,     // HEAD probe running (drawn then blocks)
    ServerFail,   // probe returned false
    ServerOk      // probe succeeded — manifest check added in next step
  };
  ...
  int         focusItem_    = 0;  // 0=Stable  1=Dev  2=CheckBtn
