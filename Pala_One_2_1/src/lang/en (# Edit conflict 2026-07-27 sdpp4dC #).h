...
#define D_WEB_TIMINGS_LONG_LABEL     "Long threshold"
...
#define D_WEB_TIMINGS_VLONG_LABEL    "Very-long threshold"
...
#define D_WEB_TIMINGS_DEBOUNCE_HINT  "Events closer together than this are ignored."
